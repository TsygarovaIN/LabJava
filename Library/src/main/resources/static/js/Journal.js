...
async function getJournal() {
    ...
    if (response.ok) {
        ...
        alert("JournalRecordId with id " + JournalId + " not Found")
    }
}
...
async function deleteJournal() {
    ...
    if (response.ok) {
        ...
        alert("JournalRecord for deleting with id " + journalId + " not Found")
    }
}
...
async function updateJournal() {
    ...
    if (response.ok) {
        ...
        alert("Journal for updating with id " + journalID + " not found or BookId/Client does not exist");
    }
}