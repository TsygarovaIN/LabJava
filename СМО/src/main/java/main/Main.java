...
public class Main {
    ...
    public static double lambda = 0.6;        //параметр lambda для экспоненциального закона распределения обработки прибора
...
//                    }
                    ...
                    for (Source s : sources) {
                        ...
                        StringBuilder forTableCount = Draw.drawInt(s.getCountRequest(), 14);
                        StringBuilder forTableRefusal = Draw.drawTime((double) s.getCountRefusal() / s.getCountRequest(), 15);
                        StringBuilder forTableTimeInSystem = Draw.drawTime((srTOb + srTBP), 15);
                        StringBuilder forTableTimeInDevice = Draw.drawTime(srTOb, 15);
                        StringBuilder forTableTimeInBuffer = Draw.drawTime(srTBP, 15);
                    ...
                    for (Device d : devices) {
                        StringBuilder forTableK = Draw.drawTime(d.getTimeInDevice() / systemTime, 13);
                        System.out.println("|    П" + d.getNumber() + "   " + forTableK + "|");
                    }
                    System.out.println("|_________|______________|");
